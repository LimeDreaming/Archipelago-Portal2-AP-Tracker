...
Tracker:AddLocations("locations/chapter1_needed.json")
Tracker:AddLocations("locations/chapter2_locations.json")
Tracker:AddLocations("locations/chapter2_needed.json")
Tracker:AddLocations("locations/chapter3_locations.json")
Tracker:AddLocations("locations/chapter3_needed.json")
Tracker:AddLocations("locations/chapter4_locations.json")
Tracker:AddLocations("locations/chapter4_needed.json")
Tracker:AddLocations("locations/chapter5_locations.json")
Tracker:AddLocations("locations/chapter5_needed.json")
Tracker:AddLocations("locations/chapter6_locations.json")
Tracker:AddLocations("locations/chapter6_needed.json")
Tracker:AddLocations("locations/chapter7_locations.json")
Tracker:AddLocations("locations/chapter7_needed.json")
Tracker:AddLocations("locations/chapter8_locations.json")
Tracker:AddLocations("locations/chapter8_needed.json")
Tracker:AddLocations("locations/chapter9_locations.json")
Tracker:AddLocations("locations/chapter9_needed.json")
